...
namespace ft {
	...
	// Construcut a pair Object. This involbe individuallt constructing its two component
	// objects, with an initialization that depends on the constructor form invoked: 
    ...
    bool operator==(const Node<T> &x) const { return value.first == x.value.first; }
	};
